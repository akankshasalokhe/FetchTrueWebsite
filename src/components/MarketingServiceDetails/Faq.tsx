...
const FAQs = () => {
    ...
    return (
        <section className="bg-gray-100 py-4">
            ...
            <div className="lg:w-[1300px] md:max-w-6xl lg:max-w-none mx-auto border-t-4 border-blue-500 rounded-xl bg-white px-2 py-2 md:px-4 md:py-4 lg:px-12 lg:py-12">

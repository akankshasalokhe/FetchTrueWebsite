...
export default function TopPopular({   selectedRange = "all",
    ...
    return (
        <div className="w-full p-2 h-auto md:ml-6 md:p-6">
            ...
            <div
              ...
              >
              <div className="flex gap-6 px-15 py-12  rounded-xl" style={{backgroundColor:"#FA9131"}}>
                 ...
                 {filteredServices.length > 0 ? (
                    ...
                    >
                        ...
                        <div className="relative p-4 text-black">
                            ...
                            {/* PRICE */}
                            <div className="absolute bottom-2 md:bottom-4 md:bottom-4 right-4 bg-white text-black font-semibold text-xl px-5 py-3 rounded-2xl shadow-md">
                                ₹ {item.price}
                            </div>
                        </div>
                    </div>

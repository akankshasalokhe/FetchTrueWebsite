    ...
    <section className="bg-[#F7F7F7] p-2 md:p-18">
      <div className="lg:bg-[#EFEFF6] lg:border lg:border-gray-400 rounded-xl p-2 md:p-12">
        <div className="max-w-[1200px] mx-auto">
          {/* TITLE */}
          <div className="ml-2 md:ml-12 mb-12">
            <h2 className="more-info-title">This course includes</h2>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-2 gap-4 md:gap-12">
            {includesData.map((item) => (
              ...
              >
                {/* Pin */}
                <div className="absolute -top-5 md:-top-12 left-1/2 -translate-x-1/2">
                  <img
                    src="/image/coursepin.png"
                    alt="pin"
                    className="w-[39px] h-[28px] md:w-[75px] md:h-[54px]"
                  />
                </div>
                ...
                <div className="hidden md:flex items-center gap-6">
                  <img
                    src={item.path}
                    alt="icon"
                    className="w-[50px] h-[50px] -mt-20"
                  />

                  <div>
                    <h3 className="text-[32px] font-semibold text-gray-800 whitespace-nowrap">
                      {item.title}
                    </h3>

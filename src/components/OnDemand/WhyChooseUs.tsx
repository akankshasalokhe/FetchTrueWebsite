                ...
                <div className="pt-8 md:pt-8 mt-10 pb-8 px-4 md:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        {ITEMS.map((item, index) => (
                            <div
                                key={index}
                                className="w-full md:w-[618px] md:p-2 p-2 flex gap-4 items-start"
                            >
                                {/* ICON */}
                               <img src={item.path} alt="icon" className="object-conatin text-[#281A83] w-[24px] h-[24px] md:mt-2 md:w-[51px] md:h-[52px]" />
                                {/* TEXT */}

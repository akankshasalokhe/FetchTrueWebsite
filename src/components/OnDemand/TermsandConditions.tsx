...
//     return (
//         <section className="bg-[#F7F7F7] -mt-12 md:-mt-12 py-10 px-4">
//             {/* TITLE */}
...
//             <div className="md:max-w-6xl lg:max-w-none lg:w-[1321px] bg-white mx-auto rounded-2xl">
...
function isLikelyTitle(text: string) {
  // ends with ":" OR looks like a heading (short & capitalized)
  return (
    text.endsWith(":") ||
  ...
  return (
    <section className="bg-[#F7F7F7] py-10 px-4">
      ...
      <div className="flex items-start mb-4">
        <h2 className="text-[#D56839] lg:ml-14 px-6 py-2 text-[16px] md:text-[24px] lg:text-[32px] font-semibold">
          Terms & Conditions
        </h2>
      </div>
        ...
        <div className="p-6 md:p-8 space-y-6 shadow-sm">
          {parsedTerms.map((item, idx) => (
            <div key={idx}>
              ...
              <ul className="space-y-1 text-gray-600 text-[14px] md:text-[18px] lg:text-[24px] ml-5 list-disc">

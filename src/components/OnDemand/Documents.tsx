...
const Documents: React.FC = () => {
  ...
  return (
    <section className="bg-[#F7F7F7] py-2 -mt-5 md:py-18 px-4">
      ...
      {/* ================= DESKTOP ================= */}
      <div className="hidden md:grid max-w-[1320px] mx-auto grid-cols-2 gap-25">
...
const DocumentCard = ({ section }: { section: DocumentSection }) => {
  return (
    <div className="bg-white rounded-xl mt-4 space-x-8 gap-8 shadow-md p-4 md:p-0">
      {/* Header */}
      <div className="bg-[#D56839] hidden md:block md:text-[40px] text-white w-full text-center py-2 rounded-md font-semibold mb-4"
          style={{
      ...
      <ul className="space-y-3 md:p-6">
        {section.items.map((item, index) => (
          <li key={index} className="flex items-start gap-8 text-[14px] md:text-[24px] text-gray-700">

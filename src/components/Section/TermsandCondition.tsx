...
export default function TermsConditions({
  ...
  return (
    <section className="w-full py-12">
      <div className="max-w-[1000px] px-8 lg:px-16">
        <h2 className="text-[28px] lg:text-[34px] font-medium text-[#2164F4] mb-6">
          {heading}
        </h2>

        <div
          className="text-[#6B6B6B] text-[16px] lg:text-[18px] leading-[26px] space-y-4"

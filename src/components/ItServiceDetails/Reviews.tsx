...
//   <h2
//     className="bg-black text-white px-10 py-2 text-[12px] md:text-[18px] lg:text-[32px] font-semibold"
//     style={{
...
//                   <span className="text-[24px] md:text-[24px] lg:text-[40px] font-semibold">
//                     {OVERALL_RATING.rating}
//                   </span>
//                    <span className="text-yellow-400 text-2xl">★</span>
//                 </div>
//                 <div className="md:-ml-6">
//                 <p className="mt-2 font-semibold text-[12px] md:text-[15px] lg:text-[20px]">

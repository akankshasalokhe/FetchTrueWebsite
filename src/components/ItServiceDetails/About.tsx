      ...
      <div className="md:w-[1320px] mx-auto">
        ...
        <div className="bg-white rounded-2xl shadow-md text-gray-600 leading-relaxed">
          ...
          <div className="block md:hidden p-4">
            <p className="text-[12px]">
              Managed IT Services & Support refers to the process of assigning specialist service providers to handle the upkeep, monitoring, and management of an organization's IT systems and infrastructure is known as managed IT services and support. Businesses collaborate with managed service providers (MSPs), who offer proactive solutions, round-the-clock support, and cutting-edge technology to keep operations operating efficiently and safely, rather than managing complicated IT difficulties internally.
            </p>
        ...
        <div className="mt-10 flex justify-center overflow-hidden">
          <img
            ...
            alt="About visual"
            className="md:w-[1080px] md:h-[483px] object-cover"
          />
        </div>
      </div>
    </section>

...
export default function WhyChooseUs({ whyChooseUs }: { whyChooseUs: { title: string; description: string; icon?: string }[] }) {
    // const WHY_CHOOSE_US = [
    //     {
    //         id: 1,
                ...
                {whyChooseUs.map((item,index) => (
                    ...
                    >
                        ...
                        <div className="w-12 h-12 bg-gray-200 rounded-full flex items-center justify-center mb-4">
                            <img src={item.icon} alt={item.title} className="md:w-[43.8px] md:h-[43.8px] w-[40px] h-[40px] p-2"/>
                        </div>

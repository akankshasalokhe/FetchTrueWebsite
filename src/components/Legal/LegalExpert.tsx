          ...
          >
            {providers.map((expert) => (
              ...
              >
                ...
                <div className="w-[68px] h-[68px] rounded-full overflow-hidden bg-[#D9D9D9]">
                  <Image
                    src={expert.storeInfo.logo || "/image/legalExpert.jpg"}
                    alt={expert.fullName}
                    width={68}
                    height={68}
                    className="object-cover"
                ...
                {/* ROLE / CATEGORY */}
                <p className="text-center font-inter font-medium text-[14px] text-gray-600">
                  {expert.category_list?.[0] || "Legal Expert"}
                </p>
                ...
                <div className="flex gap-1 mt-2">
                  {[...Array(5)].map((_, i) => (
                    <span
                      key={i}
                      className={`text-[18px] ${
                        i < Math.round(expert.averageRating || 0)
                          ? "text-[#FAC338]"
                          : "text-gray-300"
                      }`}
                    >
                ...
                <div className="w-full bg-[#F8F4EF] rounded-[12px] mt-3 mb-3 px-4 py-2 flex justify-between items-center">
                  ...
                  <div className="flex items-center gap-1">
                    ...
                    <div className="text-right">
                      <p className="font-medium text-[13px]">
                        {expert.storeInfo.totalExperience} Year
                      </p>
                      <p className="text-[11px] text-gray-500">Experience</p>
                    </div>
                  </div>

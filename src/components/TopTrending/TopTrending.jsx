...
export default function TopTrending() {
  ...
  // ============ ALWAYS RIGHT → LEFT + 2 SEC PAUSE ============
useEffect(() => {
    const container = containerRef.current;
    if (!container) return;

    let index = properties.length - 1; // start at last cards.
    ...
    const scrollPrev = () => {
        ...
        // when reaching before FIRST card, jump back to LAST card
        if (index < 0) {
    ...
    const interval = setInterval(scrollPrev, 2000);
        ...
        <div className="relative w-full overflow-hidden p-4 md:p-6">
            ...
            >
                {properties.map((p) => (
                    <div
                        key={p.id}
                        className="snap-center flex-shrink-0 w-[78vw] sm:w-[60vw] md:w-[330px]
                                   relative rounded-2xl p-3 shadow-md text-white overflow-hidden select-none"
                        style={{ background: p.bgColor }}
                    >
                        {/* IMAGE */}
                        <div className="relative w-full h-40 rounded-xl">
                            ...
                            <span className="absolute top-2 left-2 bg-white text-blue-600 text-[12px] font-semibold px-2 py-1 rounded-lg shadow flex items-center gap-1">
                                <img src="/image/security.png" width={16} height={16} />
                                Trusted
                            </span>
                            ...
                            <div className="absolute -bottom-10 right-0 bg-white p-2 rounded-2xl shadow-lg flex flex-col items-center">
                                <Image src="/mockup/propertyicon.png" width={80} height={80} />
                        ...
                        <div className="mt-12 space-y-1">
                            ...
                            <div className="relative mt-3">
                                ...
                                <div className="relative z-10 p-4">
                                    ...
                                    <div className="mt-3 text-xs opacity-95 space-y-1">
                                        ...
                                        <p>Number Outlet: <b>{p.outlets}</b></p>
                                        <div className="flex items-center gap-2">
                                            <img src="/image/area.png" width={20} height={20} />
                                            <span>Area <b>{p.area}</b></span>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="relative h-0">
                                <div className="absolute bottom-2 right-0 w-[72px] h-[52px] bg-white text-black font-semibold px-4 py-4 rounded-2xl z-20">
                                    ₹{p.price}
                                </div>
                            </div>
                        </div>
